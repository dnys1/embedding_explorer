...
class _JobsPageState extends State<JobsPage> with ConfigurationManagerListener {
  ...
  Component build(BuildContext context) {
    ...
    return div(classes: 'flex flex-col h-full', [
      ...
      // Create job dialog
      if (_showCreateJobDialog) _CreateJobDialog(onClose: _hideCreateJob),
    ]);
  }
...
final class _CreateJobDialog extends StatefulComponent {
  _CreateJobDialog({required this.onClose});
...
final class _CreateJobDialogState extends State<_CreateJobDialog>
