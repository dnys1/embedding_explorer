...
import '../models/embedding_job.dart';
...
class _JobsPageState extends State<JobsPage> {
  ...
  void _createJob() {
    ...
    final job = EmbeddingJob(
      id: _configManager.embeddingJobs.generateId(),
      name: _jobName,
    ...
    _configManager.embeddingJobs.set(job.id, job);
    _hideCreateJob();
  }

  @override
  Component build(BuildContext context) {
    final jobs = _configManager.embeddingJobs.all;
  ...
  Component _buildJobStatsCard() {
    final stats = _configManager.embeddingJobs;
  ...
  void _cancelJob(String jobId) {
    _configManager.embeddingJobs.cancelJob(jobId);
  }

  String _getDataSourceName(String id) {
    final source = _configManager.dataSources.getById(id);
    return source?.name ?? 'Unknown';
  }

  String _getTemplateName(String id) {
    final template = _configManager.embeddingTemplates.getById(id);
