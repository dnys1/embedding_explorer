      ...
      div(classes: 'max-w-7xl mx-auto px-4 sm:px-6 lg:px-8', [
        ...
        div(classes: 'mb-8', [
          ...
          p(classes: 'mt-2 text-gray-600', [
            text(
              'Configure your data source to begin exploring embedding models',
            ),
          ]),
        ]),
        ...
        if (_selectedDataSource != null)
          div(classes: 'mb-6 bg-green-50 border border-green-200 rounded-md p-4', [
            div(classes: 'flex', [
              div(classes: 'flex-shrink-0', [
                svg(
              ...
              div(classes: 'space-y-4', [
                div(classes: 'flex items-start space-x-3', [
                  div(
                    ...
                    [
                      span(classes: 'text-sm font-medium text-blue-600', [
                        text('1'),
                      ]),
                    ],
                  ),
                ...
                div(classes: 'flex items-start space-x-3', [
                  div(
                    ...
                    [
                      span(classes: 'text-sm font-medium text-gray-400', [
                        text('2'),
                      ]),
                    ],
                  ),
