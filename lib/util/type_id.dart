...
String typeId([String? type]) => TypeId(type).encoded;

typedef TypeIdData = ({String type, Uuid uuid, String? encoded});

extension type TypeId._(TypeIdData _data) {
  ...
  factory TypeId.decode(String encoded) {
    final typeId = tryDecode(encoded);
    if (typeId == null) {
  ...
  static TypeId? tryDecode(String encoded) {
