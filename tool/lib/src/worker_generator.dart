...
class WorkerBeeGenerator extends GeneratorForAnnotation<WorkerBee> {
  ...
  Future<String> generateForAnnotatedElement(
    ...
    if (requestTypeEl == null || requestTypeEl is! ClassElement) {
      final requestTypeName = requestType.getDisplayString();
    ...
    final declaresJsEntrypoint = element.fields2.any(
      (el) => el.name3 == 'jsEntrypoint' && !el.isAbstract,
    );
    final declaresFallbackUrls = element.fields2.any(
      (el) => el.name3 == 'fallbackUrls' && !el.isAbstract,
    );
